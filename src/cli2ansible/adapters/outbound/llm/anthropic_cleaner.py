"""Anthropic Claude-based terminal session cleaner."""
...
class AnthropicCleaner(LLMPort):
    """Use Anthropic Claude to clean terminal sessions."""
    ...
    def clean_commands(
        ...
        """Analyze and clean terminal commands using Claude."""
        if not commands:
...
- Failed commands followed by successful ones (remove failures)"""
    ...
    def _call_api(self, prompt: str) -> dict[str, Any]:
        ...
        try:
            ...
            raise RuntimeError("Anthropic API request timed out") from e
        except Exception as e:
            raise RuntimeError("Failed to call Anthropic API") from e
    ...
    def _parse_response(
        ...
        """Parse Claude's response into cleaned commands and report."""
